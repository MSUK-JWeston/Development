...
SELECT DISTINCT c.PatientID,
	...
	coalesce(a.AppointmentDate, c.AppointmentDate) AS AppointmentDate,
	c.Activity,
	c.ServiceName,
	coalesce(a.CurrentStatusText, c.CurrentStatusText) OutcomeStatus/*,
	c.CurrentStatusReason OutcomeStatusReason,
	c.CurrentStatusCancelledReason OutcomeStatusCancelledReason,
	a.Activity,
	a.ActivityDate,
	a.CurrentStatusText*/
FROM CancelledAppointments c
left join AllAppointments a
	ON c.ReferralID = a.ReferralID
	AND c.AppointmentDate < a.AppointmentDate
	and a.activity like '%Cons%'
WHERE c.CancelledReason = 'Capacity Management'
--and c.PatientID = '1807532'
